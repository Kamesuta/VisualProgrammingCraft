...
public class SampleSandboxed {
    ...
    public static void main(String[] args) {
        ...
        // コルーチン
        runScriptInSandbox("coroutine.create(function() while true do print('loop') end end)");

        // ファイル書き込み
        runScriptInSandbox("file = io.open('test.txt', 'w') file:write('Hello, World!') file:close()");

        // require
        runScriptInSandbox("require('test')");
